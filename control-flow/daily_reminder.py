...
match priority:
    ...
    case "medium":
        if time_bound == "yes":
            ...
            print(f"Note: {task} is a low medium task. Consider completing it when you have free time.")
    case "low":
        if time_bound == "yes":
            print(f"Remainder: {task} is a low priority task and is time bound requires attention today!")
        else:
            print(f"Note: {task} is a low priority task. Consider completing it when you have free time.")
    case _:
